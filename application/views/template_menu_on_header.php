...
<html lang="en">
    ...
    <script>
    //=============alert==============
    var _message_info = "<?php echo $this->session->flashdata('message'); ?>";
    if (_message_info) {
        App.alert({message:_message_info});
    }

    var _message_alert = "<?php echo $this->session->flashdata('error'); ?>";
    if (_message_alert) {
        App.alert({message:_message_alert,type:'danger'});
    }
    </script>
