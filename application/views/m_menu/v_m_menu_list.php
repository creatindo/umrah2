      ...
      <div class='portlet light portlet-fit portlet-datatable bordered'>
        <div class='portlet-title'>
            <div class="caption">
                ...
                <span class="caption-subject font-dark sbold uppercase">M MENU  </span>
            </div>
            <div class="actions">
                <div class="btn-group" >
                        <?php echo anchor('m_menu/form/','<i class="fa fa-pencil"></i> Create',array('class'=>'btn btn-circle btn-info btn-sm'));?>
                </div>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-right">
                        <li>
                            <?php echo anchor(site_url('m_menu/excel'), ' Export to Excel', ''); ?>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <script type="text/javascript">
            var TableDatatablesAjax = function () {
                ...
                grid.init({
                    ...
                    dataTable: {  
                        "ajax": {
                            "url": "<?php echo site_url('m_menu/getDatatable/') ?>", // ajax source
                        },
                        "order": [
                            [1, "asc"]
